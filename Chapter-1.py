...
points = 10  # Points or other bonuses could be used here (not really in use for now)
...
energy = 100  # Starting energy
time = 90     # Starting time in seconds
...
def manage_energy_and_time(action_cost, time_cost):
    ...
    if energy <= 0:
        ...
        print("Time's up! You failed to leave the Foothills.")
        exit()
    else:
...
def proceed_to_level_2():
    print("Congratulations, you’ve completed The Foothills!")
