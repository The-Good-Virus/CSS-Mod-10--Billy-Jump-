...
points = 6  # Points or other bonuses could be used here (not really in use for now)
...
def find_food():
    ...
    if food_found:
        ...
        tracks += 4  # Gain 4 tracks for finding food
    else:
...
def jump():
    ...
    if success:
        ...
        tracks += 5  # Gain 5 tracks for success
    else:
...
def start_game():
    global tracks
    print("Game Starting...")
    print("Level 3: Explore the Subalpine Zone.")
